...
const getResultsFromPage = async (page) => {
  return await page.evaluate(() =>
    Array.from(document.querySelectorAll(".s-result-item:not(.a-section, .s-widget)")).map((el) => ({
      ...
      thumbnail: el
        ...
        .reverse()[0]
        .replace(/ [\d|\.]{1,3}x/gm, ""),
      bage: el.querySelector('[data-component-type="s-status-badge-component"] .a-badge-label-inner')?.textContent.trim(),
      rating:
        parseFloat(
          (
            el.querySelector(".s-product-image-container + div > div:nth-child(2) span:first-child") ||
            el.querySelector(".s-list-col-right > div > div > div:nth-child(2) > div > span:first-child")
          )
      ...
      reviews:
        parseInt(
          (
            el.querySelector(".s-product-image-container + div > div:nth-child(2) > div > span:last-child") ||
            el.querySelector(".s-list-col-right > div > div > div:nth-child(2) > div > span:last-child")
          )?.textContent
            .trim()
            .replace(",", "")
            .replace(".", "")
      ...
      listingHistory: (
        el.querySelector(".s-product-image-container + div > div:nth-child(2) > div:nth-child(2)") ||
        el.querySelector(".s-list-col-right > div > div > div:nth-child(2) > div:nth-child(2) > span")
      )?.textContent.trim(),
      additionalinfo: (
        el.querySelector(".s-product-image-container + div > div:nth-child(3) div > span:not(.a-price) .a-truncate-full") ||
        el.querySelector(".s-product-image-container + div > div:nth-child(3) div > span:not(.a-price)") ||
        el.querySelector(".s-list-col-right > div > div > div:nth-child(3) a.a-text-bold")
      )?.textContent.trim(),
      additionalinfo2: (
        el.querySelector(".s-product-image-container + div > div:nth-child(4) span.a-size-base") ||
        el.querySelector(".s-list-col-right > div > div > div:nth-child(3) .a-section:nth-child(2)")
      )?.textContent.trim(),
      price: (
        el.querySelector(".s-product-image-container + div > div:nth-child(3) .a-price .a-offscreen") ||
        el.querySelector(".s-list-col-right > div > div > div:nth-child(3) a .a-price .a-offscreen")
      )?.textContent.trim(),
    }))
  );
};

const getListings = async (multiplierArgument, query, limit, currency, language, priceFrom, priceTo, customerReviewsRating) => {
  ...
  const url = `https://www.amazon.com/s?k=${query}${selectedLanguage ? `&language=${selectedLanguage}` : ""}${priceFrom || priceTo ? "&rh=" : ""}${
